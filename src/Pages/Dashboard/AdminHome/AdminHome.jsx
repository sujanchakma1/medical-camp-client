...
const AdminHome = () => {
  ...
  return (
    <div className="p-5">
      ...
      <p className="text-gray-500 mb-6">Here is your dashboard overview.</p>

      {/* Stats Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className=" shadow-md p-5 flex items-center gap-4 rounded-lg">
            ...
            <tbody>
              {recentParticipants.map((p) => (
                <tr key={p._id} className="">
                  <td className="px-4 py-2">{p.participant_name}</td>
                  <td className="px-4 py-2">{p.participant_email}</td>
                  <td className="px-4 py-2">{p.camp_name}</td>
