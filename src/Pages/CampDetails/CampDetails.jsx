...
const CampDetails = () => {
  ...
  const handleJoinCamp = async (e) => {
    ...
    const campFee = parseFloat(camp.camp_fees);
    ...
    if (campFee === 0) {
      ...
      // Paid camp, payment_status = Pending
      // Save participant temporarily in sessionStorage and navigate to payment page
      participant.paid = false;
      participant.payment_status = "Pending";

      sessionStorage.setItem("pendingParticipant", JSON.stringify(participant));
      if (modalRef.current) modalRef.current.close();
