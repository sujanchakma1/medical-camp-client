    ...
    >
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {camps.map((camp, index) => (
          <div
            key={index}
            className="bg-gradient-to-b from-gray-50 to-gray-200 rounded-2xl shadow-md flex flex-col overflow-hidden hover:shadow-xl hover:scale-102 transition-all"
          >
            <img
              src={camp.image}
              alt={camp.camp_name}
